...
beautiful.init(gears.filesystem.get_themes_dir() .. "razmelon/theme.lua")
...
-- Add a titlebar if titlebars_enabled is set to true in the rules. ((around line 510ish))
